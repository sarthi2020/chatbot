...
class Chatbot:
	def __init__(self):
		self.data = {"indents":[{
		    ...
		    "do you want to hang out some time?", "what are your plans for this week","What are your weekend plans","Are you free?"],
		    "answers": ["I am available all week", "I don't have any plans", "I am free"]
		    },
		    {"type": "name",
        ...
        {"type": "hobbies",
         	"questions": ["What are your hobbies?", "What do you do in you free time?", "What do you like to do in your free time?"],
         	"answers": ["I like to assist people"],
        },
		]}
